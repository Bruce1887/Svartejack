...
def hand(x):
    ...
    return sum
'''
Funktionen "hand" sätter alltid värdet på ess till ett. I funktionen "pointsfunc"
...
while(mainloop):
    ...
    while(gameloop):
        ...
        spelare_points = pointsfunc(spelare, spelare_points)
        dealer_points = pointsfunc(dealer, dealer_points)
        ...
        while(True):
            ...
            if val == '1':
                ...
                standing = True
                while pointsfunc(dealer, dealer_points) <= 16:
